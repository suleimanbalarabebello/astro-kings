...
export const ROUTES = ['home', 'browse', 'venue', 'booking', 'dashboard', 'pricing', 'leagues', 'about', 'login', 'getagame', 'juniors', 'payandplay', 'skills', 'parties', 'academy', 'clubs', 'events', 'manvfat', 'kingsclub', 'coaching', 'nottsolympic', 'performancezone', 'shop', 'contact'];
